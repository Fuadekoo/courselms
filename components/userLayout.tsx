...
function UserLayoutContent({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50/50 to-white dark:from-gray-950 dark:via-gray-900/50 dark:to-gray-900 relative">
      ...
      />
      {/* Layer 2 - Upper-Mid: Light blur (2.5px) */}
      <div
      ...
      />
      {/* Layer 4 - Lower-Mid: Medium blur (48px) */}
      <div
      ...
      />
      {/* Layer 5 - Bottom: More blurred (72px) */}
      <div
